public class Main {
    public static void main(String[] args) {
        ...
        double credit1 = service.calculate(amount, percentage, term1);
        double credit2 = service.calculate(amount, percentage, term2);
        double credit3 = service.calculate(amount, percentage, term3);
        int result1 = (int) credit1;
        int result2 = (int) credit2;
        int result3 = (int) credit3;
